...
public class Controller {
    ...
    public void btnCode(ActionEvent event){
        ...
        if(event.getSource()==btnPantA1){
            ...
            String svartekst = String.valueOf(object.getCountMonays());
            txtCountOfMoneyOutput.setText(svartekst);

            //Output in console
            System.out.println("Pant A can added.    \t\tTotal inserts: " + object.getCountItems() + ".\t\tTotal value (DDK): " + object.getCountMonays());
            ...
            //Output in console
            System.out.println("Pant A bottle added. \t\tTotal inserts: " + object.getCountItems() + ".\t\tTotal value (DDK): " + object.getCountMonays());
        }
            ...
            //Output in console
            System.out.println("Pant B bottle added. \t\tTotal inserts: " + object.getCountItems() + ".\t\tTotal value (DDK): " + object.getCountMonays());
        }
            ...
            //Output in console
            System.out.println("Pant C bottle added. \t\tTotal inserts: " + object.getCountItems() + ".\t\tTotal value (DDK): " + object.getCountMonays());
        }
